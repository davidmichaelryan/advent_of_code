...
// console.log(divideStringBySpaces(testInput));
// console.log(groupByNewlines(divideStringBySpaces(testInput)));
...
const getNonDuplicatePassphrasesCount = input => groupByNewlines(divideStringBySpaces(input)).filter(checkIfValid).length;

console.log(getNonDuplicatePassphrasesCount(realInput));

const sortString = str => str.split('').sort().join('');

const getNonDuplicateOrAnagramPassphrasesCount = input =>
  groupByNewlines(divideStringBySpaces(input)).map(arr => arr.map(sortString)).filter(checkIfValid).length;

console.log(getNonDuplicateOrAnagramPassphrasesCount(realInput));
